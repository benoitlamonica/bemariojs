...
type CursorRef7 =
  ...
  | 'zoom-in'
  | 'zoom-out';
type TextDecorationThicknessRef1 = '0' | '1' | '2' | 'auto' | 'from-font';
...
interface TailwindBackgroundImage {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-image Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-image , MDN docs}
   */
...
interface TailwindBottom {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/top-right-bottom-left Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/bottom , MDN docs}
   */
  bottom: BottomValue;
}
...
interface TailwindGridColumn {
   ...
   * columns.
   *
   * @see {@link https://tailwindcss.com/docs/grid-column Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column , MDN docs}
   */
...
interface TailwindEnd {
   ...
   * `End`
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/end , MDN docs}
   */
  end: EndValue;
}
...
interface TailwindTextIndent {
   ...
   * block.
   *
   * @see {@link https://tailwindcss.com/docs/text-indent Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-indent , MDN docs}
   */
...
interface TailwindInset {
   ...
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/inset , MDN docs}
   */
  inset: InsetValue;
}
...
interface TailwindLeft {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/top-right-bottom-left Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/left , MDN docs}
   */
  left: LeftValue;
}
...
interface TailwindMargin {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/margin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/margin , MDN docs}
   */
  margin: MarginValue;
}
...
interface TailwindMaskImage {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-image Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-image , MDN docs}
   */
...
interface TailwindOrder {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/order Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/order , MDN docs}
   */
  order: OrderValue;
}
...
interface TailwindOutlineOffset {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/outline-offset Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/outline-offset , MDN docs}
   */
...
interface TailwindRight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/top-right-bottom-left Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/right , MDN docs}
   */
  right: RightValue;
}
...
interface TailwindRotate {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/rotate Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/rotate , MDN docs}
   */
  rotate: RotateValue;
}
...
interface TailwindGridRow {
   ...
   * rows.
   *
   * @see {@link https://tailwindcss.com/docs/grid-row Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row , MDN docs}
   */
...
interface TailwindScale {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/scale Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scale , MDN docs}
   */
  scale: ScaleValue;
}
...
interface TailwindScrollMargin {
   ...
   * container.
   *
   * @see {@link https://tailwindcss.com/docs/scroll-margin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-margin , MDN docs}
   */
...
interface TailwindSkew {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/skew Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/skew , MDN docs}
   */
  skew: SkewValue;
}
...
interface TailwindStart {
   ...
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/start , MDN docs}
   */
  start: StartValue;
}
...
interface TailwindTop {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/top-right-bottom-left Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/top , MDN docs}
   */
  top: TopValue;
}
...
interface TailwindLetterSpacing {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/letter-spacing Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/letter-spacing , MDN docs}
   */
...
interface TailwindTranslate {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/translate Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/translate , MDN docs}
   */
...
interface TailwindTextUnderlineOffset {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-underline-offset Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-underline-offset , MDN docs}
   */
...
interface TailwindZIndex {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/z-index Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/z-index , MDN docs}
   */
  zIndex: ZIndexValue;
}
...
interface TailwindContainerType {
   ...
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/container-type , MDN docs}
   */
...
interface TailwindPosition {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/position Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/position , MDN docs}
   */
...
interface TailwindAccentColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/accent-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/accent-color , MDN docs}
   */
...
interface TailwindVerticalAlign {
   ...
   * box.
   *
   * @see {@link https://tailwindcss.com/docs/vertical-align Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/vertical-align , MDN docs}
   */
...
interface TailwindAnimation {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/animation Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/animation , MDN docs}
   */
...
interface TailwindFontSmoothing {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-smoothing Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-smoothing , MDN docs}
   */
...
interface TailwindAppearance {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/appearance Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/appearance , MDN docs}
   */
...
interface TailwindAspectRatio {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/aspect-ratio Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/aspect-ratio , MDN docs}
   */
...
interface TailwindGridAutoColumns {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/grid-auto-columns Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns , MDN docs}
   */
...
interface TailwindGridAutoRows {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/grid-auto-rows Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-rows , MDN docs}
   */
...
interface TailwindBackdropFilter {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/backdrop-filter Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/backdrop-filter , MDN docs}
   */
...
interface TailwindBackfaceVisibility {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/backface-visibility Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/backface-visibility , MDN docs}
   */
...
interface TailwindFlexBasis {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex-basis Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex-basis , MDN docs}
   */
...
interface TailwindBackgroundColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-color , MDN docs}
   */
...
interface TailwindBackgroundSize {
   ...
   * image.
   *
   * @see {@link https://tailwindcss.com/docs/background-size Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-size , MDN docs}
   */
...
interface TailwindBackgroundBlendMode {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-blend-mode Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-blend-mode , MDN docs}
   */
...
interface TailwindBackgroundPosition {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-position Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-position , MDN docs}
   */
...
interface TailwindBackgroundClip {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-clip Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-clip , MDN docs}
   */
...
interface TailwindBackgroundAttachment {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-attachment Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-attachment , MDN docs}
   */
...
interface TailwindBackgroundRepeat {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-repeat Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-repeat , MDN docs}
   */
...
interface TailwindBackgroundOrigin {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/background-origin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/background-origin , MDN docs}
   */
...
interface TailwindDisplay {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/display Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/display , MDN docs}
   */
...
interface TailwindFilter {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/filter Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/filter , MDN docs}
   */
  filter: FilterValue;
}
...
interface TailwindBorderWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/border-width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-width , MDN docs}
   */
...
interface TailwindBorderColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/border-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-color , MDN docs}
   */
...
interface TailwindBorderCollapse {
   ...
   * separated.
   *
   * @see {@link https://tailwindcss.com/docs/border-collapse Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-collapse , MDN docs}
   */
...
interface TailwindBorderStyle {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/border-style Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-style , MDN docs}
   */
...
interface TailwindBorderSpacing {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/border-spacing Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-spacing , MDN docs}
   */
...
interface TailwindBoxSizing {
   ...
   * total size.
   *
   * @see {@link https://tailwindcss.com/docs/box-sizing Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/box-sizing , MDN docs}
   */
...
interface TailwindBoxDecorationBreak {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/box-decoration-break Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/box-decoration-break , MDN docs}
   */
...
interface TailwindBreakAfter {
   ...
   * element.
   *
   * @see {@link https://tailwindcss.com/docs/break-after Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/break-after , MDN docs}
   */
...
interface TailwindWordBreak {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/word-break Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/word-break , MDN docs}
   */
...
interface TailwindBreakBefore {
   ...
   * element.
   *
   * @see {@link https://tailwindcss.com/docs/break-before Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/break-before , MDN docs}
   */
...
interface TailwindBreakInside {
   ...
   * element.
   *
   * @see {@link https://tailwindcss.com/docs/break-inside Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/break-inside , MDN docs}
   */
...
interface TailwindTextTransform {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-transform Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-transform , MDN docs}
   */
...
interface TailwindCaptionSide {
   ...
   * table.
   *
   * @see {@link https://tailwindcss.com/docs/caption-side Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/caption-side , MDN docs}
   */
...
interface TailwindCaretColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/caret-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/caret-color , MDN docs}
   */
...
interface TailwindClear {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/clear Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/clear , MDN docs}
   */
  clear: ClearValue;
}
...
interface TailwindVisibility {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/visibility Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/visibility , MDN docs}
   */
...
interface TailwindColumns {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/columns Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/columns , MDN docs}
   */
...
interface TailwindContain {
   ...
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/contain , MDN docs}
   */
...
interface TailwindMaxWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/max-width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/max-width , MDN docs}
   */
...
interface TailwindAlignContent {
   ...
   * grid containers.
   *
   * @see {@link https://tailwindcss.com/docs/align-content Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/align-content , MDN docs}
   */
...
interface TailwindContent {
   ...
   * pseudo-elements.
   *
   * @see {@link https://tailwindcss.com/docs/content Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/content , MDN docs}
   */
...
interface TailwindCursor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/cursor Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/cursor , MDN docs}
   */
  cursor: CursorValue;
}
...
interface TailwindTextDecorationThickness {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-decoration-thickness Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-thickness , MDN docs}
   */
...
interface TailwindTextDecorationColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-decoration-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-color , MDN docs}
   */
...
interface TailwindTextDecorationStyle {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-decoration-style Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-style , MDN docs}
   */
...
interface TailwindTransitionDelay {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transition-delay Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transition-delay , MDN docs}
   */
...
interface TailwindFontVariantNumeric {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-variant-numeric Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-numeric , MDN docs}
   */
...
interface TailwindTransitionDuration {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transition-duration Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transition-duration , MDN docs}
   */
...
interface TailwindTransitionTimingFunction {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transition-timing-function Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transition-timing-function , MDN docs}
   */
...
interface TailwindFieldSizing {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/field-sizing Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/field-sizing , MDN docs}
   */
...
interface TailwindFill {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/fill Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/fill , MDN docs}
   */
  fill: FillValue;
}
...
interface TailwindFlex {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex , MDN docs}
   */
  flex: FlexValue;
}
...
interface TailwindFlexDirection {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex-direction Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex-direction , MDN docs}
   */
...
interface TailwindFlexWrap {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex-wrap Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex-wrap , MDN docs}
   */
...
interface TailwindFloat {
   ...
   * Utilities for controlling the wrapping of content around an element.
   *
   * @see {@link https://tailwindcss.com/docs/float Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/float , MDN docs}
   */
  float: FloatValue;
}
...
interface TailwindFontWeight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-weight Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-weight , MDN docs}
   */
...
interface TailwindFontFamily {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-family Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-family , MDN docs}
   */
...
interface TailwindFontStretch {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-stretch Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-stretch , MDN docs}
   */
...
interface TailwindForcedColorAdjust {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/forced-color-adjust Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/forced-color-adjust , MDN docs}
   */
...
interface TailwindGap {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/gap Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/gap , MDN docs}
   */
  gap: GapValue;
}
...
interface TailwindGridTemplateColumns {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/grid-template-columns Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns , MDN docs}
   */
...
interface TailwindGridAutoFlow {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/grid-auto-flow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow , MDN docs}
   */
...
interface TailwindGridTemplateRows {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/grid-template-rows Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows , MDN docs}
   */
...
interface TailwindFlexGrow {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex-grow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex-grow , MDN docs}
   */
...
interface TailwindHeight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/height Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/height , MDN docs}
   */
  height: HeightValue;
}
...
interface TailwindHyphens {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/hyphens Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/hyphens , MDN docs}
   */
...
interface TailwindBoxShadow {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/box-shadow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/box-shadow , MDN docs}
   */
...
interface TailwindIsolation {
   ...
   * stacking context.
   *
   * @see {@link https://tailwindcss.com/docs/isolation Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/isolation , MDN docs}
   */
...
interface TailwindFontStyle {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-style Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-style , MDN docs}
   */
...
interface TailwindAlignItems {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/align-items Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/align-items , MDN docs}
   */
...
interface TailwindJustifyContent {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/justify-content Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content , MDN docs}
   */
...
interface TailwindJustifyItems {
   ...
   * axis.
   *
   * @see {@link https://tailwindcss.com/docs/justify-items Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/justify-items , MDN docs}
   */
...
interface TailwindJustifySelf {
   ...
   * inline axis.
   *
   * @see {@link https://tailwindcss.com/docs/justify-self Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self , MDN docs}
   */
...
interface TailwindLineHeight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/line-height Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/line-height , MDN docs}
   */
...
interface TailwindLineClamp {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/line-clamp Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/line-clamp , MDN docs}
   */
...
interface TailwindTextDecorationLine {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-decoration-line Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-line , MDN docs}
   */
...
interface TailwindListStyleType {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/list-style-type Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/list-style-type , MDN docs}
   */
...
interface TailwindListStyleImage {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/list-style-image Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/list-style-image , MDN docs}
   */
...
interface TailwindListStylePosition {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/list-style-position Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/list-style-position , MDN docs}
   */
...
interface TailwindMaskComposite {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-composite Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-composite , MDN docs}
   */
...
interface TailwindMaskMode {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-mode Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-mode , MDN docs}
   */
...
interface TailwindMaskSize {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-size Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-size , MDN docs}
   */
...
interface TailwindMaskPosition {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-position Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-position , MDN docs}
   */
...
interface TailwindMaskClip {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-clip Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-clip , MDN docs}
   */
...
interface TailwindMaskRepeat {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-repeat Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-repeat , MDN docs}
   */
...
interface TailwindMaskOrigin {
   ...
   * relative to borders, padding, and content.
   *
   * @see {@link https://tailwindcss.com/docs/mask-origin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-origin , MDN docs}
   */
...
interface TailwindMaskType {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mask-type Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mask-type , MDN docs}
   */
...
interface TailwindMaxHeight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/max-height Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/max-height , MDN docs}
   */
...
interface TailwindMinHeight {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/min-height Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/min-height , MDN docs}
   */
...
interface TailwindMinWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/min-width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/min-width , MDN docs}
   */
...
interface TailwindMixBlendMode {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/mix-blend-mode Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/mix-blend-mode , MDN docs}
   */
...
interface TailwindObjectPosition {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/object-position Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/object-position , MDN docs}
   */
...
interface TailwindObjectFit {
   ...
   * resized.
   *
   * @see {@link https://tailwindcss.com/docs/object-fit Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit , MDN docs}
   */
...
interface TailwindOpacity {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/opacity Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/opacity , MDN docs}
   */
...
interface TailwindTransformOrigin {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transform-origin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin , MDN docs}
   */
...
interface TailwindOutlineWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/outline-width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/outline-width , MDN docs}
   */
...
interface TailwindOutlineColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/outline-color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/outline-color , MDN docs}
   */
...
interface TailwindOutlineStyle {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/outline-style Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/outline-style , MDN docs}
   */
...
interface TailwindOverflow {
   ...
   * for the container.
   *
   * @see {@link https://tailwindcss.com/docs/overflow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/overflow , MDN docs}
   */
...
interface TailwindOverscrollBehavior {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/overscroll-behavior Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/overscroll-behavior , MDN docs}
   */
...
interface TailwindPadding {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/padding Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/padding , MDN docs}
   */
...
interface TailwindPerspective {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/perspective Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/perspective , MDN docs}
   */
...
interface TailwindPerspectiveOrigin {
   ...
   * space.
   *
   * @see {@link https://tailwindcss.com/docs/perspective-origin Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/perspective-origin , MDN docs}
   */
...
interface TailwindPlaceContent {
   ...
   * time.
   *
   * @see {@link https://tailwindcss.com/docs/place-content Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/place-content , MDN docs}
   */
...
interface TailwindPlaceItems {
   ...
   * time.
   *
   * @see {@link https://tailwindcss.com/docs/place-items Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/place-items , MDN docs}
   */
...
interface TailwindPlaceSelf {
   ...
   * at the same time.
   *
   * @see {@link https://tailwindcss.com/docs/place-self Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/place-self , MDN docs}
   */
...
interface TailwindColor {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/color Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/color , MDN docs}
   */
  color: ColorValue;
}
...
interface TailwindPointerEvents {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/pointer-events Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/pointer-events , MDN docs}
   */
...
interface TailwindResize {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/resize Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/resize , MDN docs}
   */
  resize: ResizeValue;
}
...
interface TailwindBorderRadius {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/border-radius Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius , MDN docs}
   */
...
interface TailwindColorScheme {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/color-scheme Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/color-scheme , MDN docs}
   */
...
interface TailwindScrollBehavior {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/scroll-behavior Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-behavior , MDN docs}
   */
...
interface TailwindScrollPadding {
   ...
   * container.
   *
   * @see {@link https://tailwindcss.com/docs/scroll-padding Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding , MDN docs}
   */
...
interface TailwindUserSelect {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/user-select Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/user-select , MDN docs}
   */
...
interface TailwindAlignSelf {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/align-self Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/align-self , MDN docs}
   */
...
interface TailwindFlexShrink {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/flex-shrink Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/flex-shrink , MDN docs}
   */
...
interface TailwindWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/width , MDN docs}
   */
  width: WidthValue;
}
...
interface TailwindScrollSnapAlign {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/scroll-snap-align Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-align , MDN docs}
   */
...
interface TailwindScrollSnapStop {
   ...
   * positions.
   *
   * @see {@link https://tailwindcss.com/docs/scroll-snap-stop Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-stop , MDN docs}
   */
...
interface TailwindScrollSnapType {
   ...
   * container.
   *
   * @see {@link https://tailwindcss.com/docs/scroll-snap-type Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-type , MDN docs}
   */
...
interface TailwindStrokeWidth {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/stroke-width Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/stroke-width , MDN docs}
   */
...
interface TailwindStroke {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/stroke Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/stroke , MDN docs}
   */
  stroke: StrokeValue;
}
...
interface TailwindTableLayout {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/table-layout Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/table-layout , MDN docs}
   */
...
interface TailwindFontSize {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/font-size Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/font-size , MDN docs}
   */
...
interface TailwindTextWrap {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-wrap Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-wrap , MDN docs}
   */
...
interface TailwindTextAlign {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-align Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-align , MDN docs}
   */
...
interface TailwindTextOverflow {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-overflow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-overflow , MDN docs}
   */
...
interface TailwindTextShadow {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/text-shadow Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow , MDN docs}
   */
...
interface TailwindTouchAction {
   ...
   * touchscreens.
   *
   * @see {@link https://tailwindcss.com/docs/touch-action Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/touch-action , MDN docs}
   */
...
interface TailwindTransform {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transform Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transform , MDN docs}
   */
...
interface TailwindTransformStyle {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transform-style Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-style , MDN docs}
   */
...
interface TailwindTransformBox {
   ...
   *
   * @see {@link https://tailwindcss.com/docs Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-box , MDN docs}
   */
...
interface TailwindTransitionProperty {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transition-property Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transition-property , MDN docs}
   */
...
interface TailwindTransitionBehavior {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/transition-behavior Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/transition-behavior , MDN docs}
   */
...
interface TailwindWhiteSpace {
   ...
   *
   * @see {@link https://tailwindcss.com/docs/white-space Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/white-space , MDN docs}
   */
...
interface TailwindWillChange {
   ...
   * to change.
   *
   * @see {@link https://tailwindcss.com/docs/will-change Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/will-change , MDN docs}
   */
...
interface TailwindOverflowWrap {
   ...
   * element.
   *
   * @see {@link https://tailwindcss.com/docs/overflow-wrap Tailwind docs} {@link
   * https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-wrap , MDN docs}
   */
